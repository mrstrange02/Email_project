...
<form name="f1" action="DeleteMail1.jsp?mid=<%=mid%>">
...
<tr><td></td><td><br><br><input type=submit value="Delete" class="myButton"></form>
<form name=f2 action=inbox-1.jsp>
<input type=submit value="Back" class="myButton"></td></tr>
</table></form>
